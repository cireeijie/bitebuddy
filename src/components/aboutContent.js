...
import aboutContentPhoto from "../images/image 6.png"
        ...
        <div className='about-content'>
            <div className='about-content-text'>
                ...
                <div className='about-content-desc'>
                    ...
                    <span>With BiteBuddy, you can skip the hassle of making reservations and waiting in line. Our easy-to-use platform allows you to search for restaurants, compare prices and menus, and book a table in seconds. Plus, you can earn rewards for every reservation you make, which can be redeemed for discounts on your next meal.
                    </span><br/><br/>
                    <span>
